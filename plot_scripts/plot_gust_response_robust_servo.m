...
aircraft.actuators.LAD.omega = 100;
...
aircraft.actuators.LAD.omega = aircraft.actuators.LAD.omega * 1.5/2;
simout{2} = simGust(gust_grad_dist,time,is_gla_enabled,is_failure);

aircraft.actuators.LAD.omega = aircraft.actuators.LAD.omega * 1/1.5;
simout{3} = simGust(gust_grad_dist,time,is_gla_enabled,is_failure);

aircraft.actuators.LAD.omega = aircraft.actuators.LAD.omega / 1.5;
...
if is_tikz_export_desired
    ...
    filename = exportFilename('gust_response_servo_wrbm.tex');
